...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Borderless Window', 'If checked, disables the window boarders.', 'borderlesswindows', 'bool', false);
		addOption(option);
		option.onChange = onChangeborders;
	...
	function onChangeborders()
	{
		Application.current.window.borderless = ClientPrefs.borderlesswindows;
	}
